...
TEST_CASE("non-general expression") {
  SymmetricMatrix<double, ShapeC<2,2>> s1, s2;
  s1 = {{3, 7}, {7, 9}};
  executer(s2 = s1+5);
...
TEST_CASE("conversions") {
  SymmetricMatrix<double, ShapeC<2,2>> s1;
  LowerTriangularMatrix<double, ShapeC<2,2>> lt1;
  UpperTriangularMatrix<double, ShapeC<2,2>> ut1;
  Matrix<double, ShapeC<2,2>> m1, m2;
