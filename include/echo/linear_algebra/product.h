...
namespace detail { namespace product {
...
auto emplace_product(const ExecutionContext& execution_context,
  ...
  execution_context.gemv(matrix_traits::operation<A>(),
                          a_m, a_n, alpha,
                          a.data(), lda, x.data(),
...
//                           A::storage_uplo, a_m, b_n, alpha, a.data(),
//                           lda, b.data(), ldb, beta,
//                           c.data(), ldc);
...
//                           B::storage_uplo, a_m, b_n, alpha, b.data(),
//                           ldb, a.data(), lda, beta,
//                           c.data(), ldc);
//   return make_matrix_view(c);
// }
